...
ifeq ($(TARGET_DISABLES_GMS),true)
    ...
    BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 55165824      # ~52.6 MB
    BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 55165824      # ~52.6 MB
    BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 55165824  # ~52.6 MB

endif

BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 104857600   # 100 MB
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 55165824       # ~52.6 MB
